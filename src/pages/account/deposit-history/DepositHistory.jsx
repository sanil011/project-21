...
import BankTypePickerModal from "./BankTypePickerModal";
...
const depositTabs = ["All", "E-Wallet", "UPI x QR", "Paytm", "Banking"];
  ...
  useEffect(() => {
    const fetchTransactions = async () => {
      try {
        ...
        const depositsOnly = data.filter(txn => txn.transactionType === "DEPOSIT");
  ...
  return (
    <div className="game-history-container">
      ...
      <div className="game-history-header">
        ...
        <h2 className="game-history-title">Deposit history</h2>
      </div>
